...
<div class="main-header">
    ...
    <p>Tác giả: Triệu Thị Trang - Trường Tiểu học Minh Quang - ĐT: 0369 511 665</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Triệu Thị Trang - Trường Tiểu học Minh Quang - ĐT: 0369 511 665</div>", unsafe_allow_html=True)
